Latex docker container [![Docker hub](https://img.shields.io/docker/pulls/noasakurajin/latex.svg)](https://hub.docker.com/r/noasakurajin/latex/)
======================
...
Versions
--------
All versions are based on Ubuntu: ([See all tags](https://hub.docker.com/r/noasakurajin/latex/))

- [noasakurajin/latex:ubuntu (:latest) - Dockerfile.ubuntu](Dockerfile.ubuntu) Ubuntu TexLive distribution: Old but stable, most needed package: texlive-full (3.9GB)
- [noasakurajin/latex:ctanbasic - Dockerfile.basic](Dockerfile.basic) CTAN TexLive Scheme-basic: Up-to-date, only basic packages, base for custom builds (500MB)
- [noasakurajin/latex:ctanfull - Dockerfile.full](Dockerfile.full) CTAN TexLive Scheme-full: Up-to-date, all packages (5.6GB)

If you need...
- ...the most-stuff-works-out-of-the-box package, try `noasakurajin/latex:ubuntu`.
- ...the most recent version of everything, try `noasakurajin/latex:ctanfull`.
- ...a stable base for your custom texlive build, try `noasakurajin/latex:ctanbasic`.

For stability, choose a more specific version tag ([See all tags](https://hub.docker.com/r/noasakurajin/latex/))
...
wget https://raw.githubusercontent.com/noasakurajin/latex-docker/master/latexdockercmd.sh
chmod +x latexdockercmd.sh

# Optional: Change the version (see above, default noasakurajin/latex:ubuntu)
...
```
FROM noasakurajin/latex:ubuntu
